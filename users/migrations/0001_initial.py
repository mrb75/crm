    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gender', models.CharField(choices=[('Male', 'مرد'), ('Female', 'زن'), ('Nothing', 'هیچکدام')], default='Nothing', max_length=10)),
                ('credit', models.BigIntegerField(default=0)),
                ('point', models.IntegerField(default=0)),
                ('company_name', models.CharField(max_length=60)),
                ('remained_sms', models.IntegerField(default=0)),
                ('date_modified', models.DateTimeField(auto_now=True)),
                ('city', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='users', to='users.city')),
